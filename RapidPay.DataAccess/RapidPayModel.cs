// Licence file C:\Users\BairesDev\Documents\ReversePOCO.txt not found.
...
namespace RapidPay.DataAccess
{
    ...
    public interface IRapidPayEntities : IDisposable
    {
        DbSet<CardPayment> CardPayments { get; set; } // CardPayment
        DbSet<CreditCard> CreditCards { get; set; } // CreditCard
        DbSet<Fee> Fees { get; set; } // Fee
        DbSet<User> Users { get; set; } // User
        DbSet<UserToken> UserTokens { get; set; } // UserToken
    ...
    public class RapidPayEntities : DbContext, IRapidPayEntities
    {
        public RapidPayEntities()
        {
        }

        public RapidPayEntities(DbContextOptions<RapidPayEntities> options)
            : base(options)
        {
        }

        public DbSet<CardPayment> CardPayments { get; set; } // CardPayment
        public DbSet<CreditCard> CreditCards { get; set; } // CreditCard
        public DbSet<Fee> Fees { get; set; } // Fee
        public DbSet<User> Users { get; set; } // User
        public DbSet<UserToken> UserTokens { get; set; } // UserToken

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer(@"data source=.;initial catalog=RapidPay;persist security info=True;user id=userRapidPay;password=P@ssw0rd;MultipleActiveResultSets=True");
            }
        }
    ...
    public class RapidPayEntitiesFactory : IDesignTimeDbContextFactory<RapidPayEntities>
    {
        public RapidPayEntities CreateDbContext(string[] args)
        {
            return new RapidPayEntities();
        }
    }
    ...
    public class FakeRapidPayEntities : IRapidPayEntities
    {
        public DbSet<CardPayment> CardPayments { get; set; } // CardPayment
        public DbSet<CreditCard> CreditCards { get; set; } // CreditCard
        public DbSet<Fee> Fees { get; set; } // Fee
        ...
        public FakeRapidPayEntities()
        {
            _database = new FakeDatabaseFacade(new RapidPayEntities());

            CardPayments = new FakeDbSet<CardPayment>("Id");
            CreditCards = new FakeDbSet<CreditCard>("Id");
            Fees = new FakeDbSet<Fee>("Id");
            Users = new FakeDbSet<User>("Id");
            UserTokens = new FakeDbSet<UserToken>("Id");
    ...
    {
        public int Id { get; set; } // Id (Primary key)
        public string CardNumber { get; set; } // CardNumber (length: 15)
        public double InitalBalance { get; set; } // InitalBalance
        public double CurrentBalance { get; set; } // CurrentBalance
    }
    ...
    {
        public int Id { get; set; } // Id (Primary key)
        public DateTime TimeFrom { get; set; } // TimeFrom
        public DateTime TimeTo { get; set; } // TimeTo
        public double CurrentFee { get; set; } // CurrentFee
    }
    ...
    public class CardPaymentConfiguration : IEntityTypeConfiguration<CardPayment>
    {
        ...
        {
            builder.ToTable("CardPayment", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_CardTransactions").IsClustered();

            builder.Property(x => x.Id).HasColumnName(@"Id").HasColumnType("int").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.CardId).HasColumnName(@"CardId").HasColumnType("int").IsRequired();
    ...
    public class CreditCardConfiguration : IEntityTypeConfiguration<CreditCard>
    {
        public void Configure(EntityTypeBuilder<CreditCard> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_CreditCard").IsClustered();

            builder.Property(x => x.Id).HasColumnName(@"Id").HasColumnType("int").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.CardNumber).HasColumnName(@"CardNumber").HasColumnType("varchar(15)").IsRequired().IsUnicode(false).HasMaxLength(15);
            builder.Property(x => x.InitalBalance).HasColumnName(@"InitalBalance").HasColumnType("float").HasPrecision(53).IsRequired();
            builder.Property(x => x.CurrentBalance).HasColumnName(@"CurrentBalance").HasColumnType("float").HasPrecision(53).IsRequired();
        }
    }
    ...
    public class FeeConfiguration : IEntityTypeConfiguration<Fee>
    {
        ...
        {
            builder.ToTable("Fee", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_Fee").IsClustered();

            builder.Property(x => x.Id).HasColumnName(@"Id").HasColumnType("int").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.TimeFrom).HasColumnName(@"TimeFrom").HasColumnType("datetime").IsRequired();
            builder.Property(x => x.TimeTo).HasColumnName(@"TimeTo").HasColumnType("datetime").IsRequired();
            builder.Property(x => x.CurrentFee).HasColumnName(@"CurrentFee").HasColumnType("float").HasPrecision(53).IsRequired();
        }
    }
    ...
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(x => x.LastName).HasColumnName(@"LastName").HasColumnType("varchar(50)").IsRequired(false).IsUnicode(false).HasMaxLength(50);
            builder.Property(x => x.Username).HasColumnName(@"Username").HasColumnType("varchar(100)").IsRequired().IsUnicode(false).HasMaxLength(100);
            builder.Property(x => x.Password).HasColumnName(@"Password").HasColumnType("varchar(max)").IsRequired().IsUnicode(false);
            builder.Property(x => x.DocumentNumber).HasColumnName(@"DocumentNumber").HasColumnType("varchar(20)").IsRequired(false).IsUnicode(false).HasMaxLength(20);
        }
    }
    ...
    public class UserTokenConfiguration : IEntityTypeConfiguration<UserToken>
    {
        public void Configure(EntityTypeBuilder<UserToken> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_UserToken").IsClustered();

            builder.Property(x => x.Id).HasColumnName(@"Id").HasColumnType("int").IsRequired().ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.UserId).HasColumnName(@"UserId").HasColumnType("int").IsRequired();
            builder.Property(x => x.Token).HasColumnName(@"Token").HasColumnType("varchar(max)").IsRequired().IsUnicode(false);
            builder.Property(x => x.CreatedDate).HasColumnName(@"CreatedDate").HasColumnType("datetime").IsRequired();
            builder.Property(x => x.ExpirationTime).HasColumnName(@"ExpirationTime").HasColumnType("int").IsRequired();
